<div class="header-content">
            ...
            <ul class="navbar-nav header-right main-notification">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50" src="{{ asset('src/images/avatar/1.jpg') }}">
                                        </div>
                ...
                <li class="nav-item dropdown header-profile">
                    <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                        <img src="{{ asset('src/images/profile/pic1.jpg') }}" width="20" alt="" />
    ...
    <div class="sub-header">
        <div class="d-flex align-items-center flex-wrap me-auto">
            <h5 class="dashboard_bar">@yield('headertitle')</h5>
        </div>
